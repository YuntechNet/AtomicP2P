...
class JoinHandler(Handler):
    ...
    def onSend(self, target, **kwargs):
        ...
        return [Message(_host=target, _hash=self.peer._hash, _type='join', _data=data)]
...
class CheckJoinHandler(Handler):
    ...
    def onSend(self, target, **kwargs):
        ...
        return [Message(_host=target, _hash=self.peer._hash, _type='checkjoin', _data=data)]
...
class NewMemberHandler(Handler):
    ...
    def onSend(self, target, peer_info, **kwargs):
        ...
        return [Message(_host=target, _hash=self.peer._hash, _type='newmember', _data=data)]
